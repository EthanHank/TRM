                ...
                <tr>
                    <td style="padding: 48px 40px 32px 40px; text-align: center;">
                        ...
                        <p style="font-size: 1.15rem; color: #333; margin-bottom: 18px;">
                            <span style="display: inline-block; background: #28a745; color: #fff; border-radius: 8px; padding: 4px 16px; font-weight: 600; font-size: 1rem; margin-bottom: 10px;">Appointment Confirmed</span><br>
                            We are pleased to inform you that your appointment has been <strong>confirmed</strong>.
                        </p>
