                ...
                <tr>
                    <td style="padding: 48px 40px 32px 40px; text-align: center;">
                        ...
                        <p style="font-size: 1.15rem; color: #333; margin-bottom: 18px;">
                            <span style="display: inline-block; background: #28a745; color: #fff; border-radius: 8px; padding: 4px 16px; font-weight: 600; font-size: 1rem; margin-bottom: 10px;">Drying Process Completed</span><br>
                            We are pleased to inform you that the drying process for your paddy has been successfully completed.
                        </p>
                        <div style="background: #f8fafc; border-radius: 12px; padding: 24px 20px; margin: 24px 0 18px 0; display: inline-block; text-align: left; box-shadow: 0 1px 4px #667eea11; min-width: 320px;">
                            <p style="font-size: 1rem; color: #667eea; margin: 0 0 8px 0; font-weight: 600;">Drying Summary</p>
                            <p style="font-size: 1rem; color: #333; margin: 0;">
                                ...
                                <strong>Date Completed:</strong> {{ \Carbon\Carbon::parse($drying->drying_end_date)->format('F d, Y') }}<br>
