...
@endif
@if(Auth::user()->hasPermissionTo('create-appointment-type'))
                ...
                <table class="table table-hover">
                    <thead>
                        <tr class="text-center align-middle">
                            <th>Name</th>
                            <th>Description</th>
                            @if (Auth::user()->hasPermissionTo('edit-appointment-type') || Auth::user()->hasPermissionTo('delete-appointment-type'))
                            <th>Action</th>
                            @endif
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            <td colspan="{{ Auth::user()->hasPermissionTo('edit-appointment-type') || Auth::user()->hasPermissionTo('delete-appointment-type') ? 3 : 2 }}" class="text-center text-muted py-4">No appointment types found! T_T</td>
                        </tr>
                        @endif
                        ...
                        <tr class="text-center align-middle">
                            ...
                            @if (Auth::user()->hasPermissionTo('edit-appointment-type') || Auth::user()->hasPermissionTo('delete-appointment-type'))
                            <td>
                                @if(Auth::user()->hasPermissionTo('edit-appointment-type'))
                                ...
                                @endif
                                @if(Auth::user()->hasPermissionTo('delete-appointment-type'))
