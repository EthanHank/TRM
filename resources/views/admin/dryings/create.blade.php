        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">Make Drying</h4>
                </div>
                <div class="card-body">
                    <div class="alert alert-info">
                        <i class="fas fa-exclamation-triangle me-2"></i>
                        You are about to make the drying process. This action will send a drying notification to the merchant.
                    </div>
                    ...
                    <form action="{{ route('admin.dryings.store') }}" method="POST">
                        @csrf
