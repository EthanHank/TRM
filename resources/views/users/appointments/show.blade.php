    ...
    <div class="card mb-4 shadow-sm" data-aos="fade-up">
        <div class="card-body">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><strong>Moisture Content</strong> {{ $appointment->moisture_content }}</li>
...
<div class="container">
    ...
    <div class="row bg-color" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
        ...
        <div class="col-lg-6 mb-4 mt-4" data-aos="fade-up" data-aos-offset="400">
    ...
    <div class="row bg-color" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
        ...
        <div class="col-lg-6 mb-4 mt-4" data-aos="fade-up" data-aos-offset="400">
            <div class="card shadow-sm border-0 fade-in-result" style="max-width: 500px; margin: 0 auto; position: relative;">
                ...
                <form action="{{ route('users.appointments.destroy', $appointment->id) }}" method="POST" style="position: absolute; top: 10px; right: 10px; z-index: 2;">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this appointment result?')">
                        <i class="bi bi-trash"></i>
                    </button>
                </form>
                @endif
