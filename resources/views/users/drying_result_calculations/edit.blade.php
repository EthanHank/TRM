...
@section('content')
<div>
    <h6 class="text-muted mb-4">User &gt; Drying Result Calculation</h6>
</div>

@if(isset($dryingResult))
    <div class="mt-5 fade-in-result">
            ...
            <div class="card-body">
                ...
                <div class="text-center mt-3">
                    <form method="POST" action="{{ route('users.drying_result_calculations.store') }}">
                        ...
                        <a href="{{ route('users.drying_result_calculations.edit', $paddy->id) }}" class="btn btn-outline-danger ms-2">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
...
<div class="container mt-5">
    <h4 class="mb-3">Calculate Drying Result</h4>
    @if(isset($success))
    ...
    <form method="POST" action="{{ route('users.drying_result_calculations.calculate') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="final_moisture_content" name="final_moisture_content" value="{{ old('final_moisture_content', '14') }}" required>
        </div>
        <div class="mb-3">
