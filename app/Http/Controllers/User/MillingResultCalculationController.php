...
class MillingResultCalculationController extends Controller
{
    ...
    public function calculate(MillingResultCalculateRequest $request)
    {
        try {
            ...
            return redirect()->back()->with('error', 'Failed to calculate milling result: ' . $e->getMessage());
        }
    }
    ...
    public function store(MillingResultCalculateRequest $request)
    {
        try {
            ...
            return redirect()->back()->with('error', 'Failed to save milling result calculation: ' . $e->getMessage());
        }
    }
    ...
    public function destroy(MillingResultCalculation $millingResultCalculation)
    {
        try {
            ...
            Log::error('Failed to delete milling result calculation: ' . $e->getMessage());
            return redirect()->back()->with('error', 'Failed to delete milling result calculation: ' . $e->getMessage());
        }
    }
}
